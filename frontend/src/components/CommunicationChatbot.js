...
const CommunicationChatbot = ({stopped, stateN, setStateN, setStopped}) => {
    ...
    const handleSubmit = async () => {  
        ...
        const userMessage = { sentence: input, speaker: 'user', labels: {}}; 
        ...
        setMessages((currentMessages) => { // 받은 데이터로 메시지 목록을 업데이트
          const updatedMessages = [...currentMessages, { sentence: data.reply, speaker: 'chatbot', labels: {} }];
    ...
    useEffect(() => {
        ...
        const handleFirstSubmit = async () => { 
          const userMessage = { text: "<START>", sender: 'user', labels: {} }; 
