    ...
    <section className="communication_page">
      ...
      <div className="communication_page_inner"><div className="communication_page_inner2">
        ...
        <div className='communication_page_top'>
          ...
          {stateN !== 2? <div className='communication_page_scorebar'><Scorebar cat={"communication"} avg={avgAvg} score={avgScore}/></div>: <></>}
        ...
        <div className='communication_page_contents'>
          {stateN===0? <CommunicationSummary stopped={stopped} stateN={stateN} setStateN={setStateN} setStopped={setStopped} historyId={historyId} setHistoryId={setHistoryId} currentPage={currentPage} setCurrentPage={setCurrentPage} score={score}/>: 
